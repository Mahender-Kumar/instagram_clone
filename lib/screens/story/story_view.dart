                                  ...
                                  itemBuilder: (context, index2) {
                                    ...
                                    switch (story.media) {
                                      ...
                                      case MediaType.video:
                                        print('video contorller cllick second');
  ...
  void _onTapDown(
    ...
    if (_pageController!.page! > 0 &&
      ...
      setState(() {
        ...
        _childpageController!.jumpTo(_currentIndex.toDouble());
      });
      _loadStory(story: stories[_currentIndex], stories: stories);
      return;
    } else if (_pageController!.page! <
            ref.watch(userProvider).value!.length - 1 &&
        // details.localPosition.dx < 50
        dx > 2 * screenwidth / 3 &&
        _childpageController!.page!.toInt() == stories.length - 1) {
      _pageController!.animateToPage(
        _pageController!.page!.toInt() + 1, // Go to the previous page
        duration: const Duration(
            milliseconds: 300), // Adjust duration for smooth animation
